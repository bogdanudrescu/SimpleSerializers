...
public class JSONDocument {
    ...
    /*
     * TODO: this should stay in a StringUtils library. But it's much simple to
     * have this API solely without any other needed references. We'll keep this
     * private anyway, as long as it's here.
     * 
     * Replace all the text in targets with what's in replacements for the same
     * position in array.
     * 
